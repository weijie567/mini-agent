...
| GSD | `BLOCKED_REVIEW_SCOPE_REMEDIATION / PAUSED / NOT_EFFECTIVE` | activation branch 从 integration exact base `85eb2a7...` fork；`1e6999c...`、`f740812...`、`b659c33...` 与 `f48461c...` 均保留 blocked-review 记录；`f48461c...` 因 non-literal tracked check、不可执行 transcript assertion 与 trace drift 被阻断；新候选 head 的双 review 与 PR merge 为 `PENDING` |
