...
| GSD | `ACTIVE / EFFECTIVE / B_FE_EXPAND_CONFIRMED / I_P_READY` | activation PR #10生效；D/H、N与O均已有reviewed merge，PR #67/#68形成`B_O_STATUS`，PR #70–#74形成`B_F`与`B_FE_EXPAND`，PR #75/#76/#77完成evidence-only cross-file alignment；I/P已由exact `B_FE_EXPAND`解锁 |
...
| W2 dispatch | `RUNTIME / INFRA / EVAL / TRACE / EVIDENCE_BOUNDARY / C_G_D_H_N_O_F_E REVIEWED_MERGED / B_FE_EXPAND_CONFIRMED / I_P_READY` | Runtime PR #34 merge `fb607019...`、Infra PR #36 merge `8e21652...`、Eval PR #29 merge `eee1c0e...`、01-07A PR #38 merge `4cfac0a...`、01-07B PR #44 merge `ccdafe87...`、01-07G PR #50 merge `bfc63c9...`、01-07C r1 PR #53 merge `327b39d...`、D/H PR #59/#60形成`4a7e802...`、N PR #63形成`a4b1edb...`、O PR #65形成`7332091...`、F PR #71形成`034cf57...`、E PR #74形成non-routable `B_FE_EXPAND = 294ada3...`；I/P从该exact barrier启动 |
| `E2E01-01/04` 生命周期 | `CONTRACT_DEFINED` | 尚无运行证据 |

W0、W1、W2.0 contract freeze、GSD activation、Plans 01-01–01-04、inserted completed Packets 01-04D/E/F/G/H、01-07A/B/C/D/E/F/G/H/N/O、replacement 01-05R/01-06R与01-07已有完成证据；numbered Plan evidence口径仍是7/8，canonical lifecycle与派生checkbox仍保持0/8。当前reviewed feature完成证据为22/39；正式Plan总数为24，现有Summary为22，F/E Summary与派生状态已由PR #75索引，Project Direction与README再由PR #76/#77对齐。Plan签发、execution-map落盘或状态索引都不等于后续Task Packet实现完成。

下一步是从exact `B_FE_EXPAND`签发01-07I / 01-07P dependency expand，而不是重新签发F/E；两者使用互斥ownership并由Integrator串行形成`B_IP`，后续严格服从唯一execution map。F/E已有owner implementation、independent exact-head review、latest-integration replay、serial merge及post-merge验证，但`B_FE_EXPAND`仍是non-routable additive barrier；上述证据不支持“切片可运行”“active routing已切换”或“Case已通过”结论。
