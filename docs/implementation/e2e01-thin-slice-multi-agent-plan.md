...
| GSD | `ACTIVE / EFFECTIVE / 01-07C_ISSUED / 01-07G_NEXT` | activation PR #10生效；01-01至01-07B已evidence-indexed；01-07C Plan固定execution base `3f0753f7...`与Intent owner单文件ownership但feature未开始；01-07G等待独立planning PR，后续Packet继续遵守共同barrier |
