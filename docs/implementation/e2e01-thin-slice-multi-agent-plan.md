...
| GSD | `ACTIVE / EFFECTIVE / 01-07C_01-07G_ISSUED / FEATURE_DISPATCH_NEXT` | activation PR #10生效；01-01至01-07B已evidence-indexed；01-07C/01-07G Plans固定同一execution base `3f0753f7...`与互不重叠的单owner文件，feature均未开始；本planning PR reviewed merge后才并行dispatch，后续Packet继续遵守共同barrier |
