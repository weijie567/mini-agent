...
| 01-07G Thin Slice `get_order` source-version ruling | scoped owner定义server-private version唯一来源/算法、FOUND必填、Observation/Manifest exact copy与禁止schema fallback；不实现Core DTO | `READY / PLAN_NOT_YET_ISSUED` |
